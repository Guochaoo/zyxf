/**
 * CalendarArrowDownIcon — 时间升序排序（lucide calendar-arrow-down）
 *
 * 约定（新图标请遵循）：
 ...
 * - 文件名以 Icon 结尾（如 CalendarArrowDownIcon.jsx），并在此目录的 index.js 中导出
 */
export default function CalendarArrowDownIcon({ className = 'w-4 h-4' }) {
  return (
    <svg
