...
function Section({ label, sub, time, body, resolving }) {
  return (
    <div
...
export default function ChatComposer() {
  ...
  return (
    <div className="flex min-h-[288px] w-full max-w-95 flex-1 flex-col overflow-hidden rounded-[14px] bg-surface shadow-card">
      {/* header — tabs + actions */}
