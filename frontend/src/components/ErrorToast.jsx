...
export default function ErrorToast({ message, sub = '请检查后重试', duration = 3500, onClose }) {
  ...
  return (
    ...
    >
      <svg className="error-toast__wave" viewBox="0 0 1440 320" xmlns="http://www.w3.org/2000/svg" aria-hidden>
        <path
      ...
      <div className="error-toast__icon">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor" aria-hidden>
      ...
      <div className="error-toast__text">
        ...
        <p className="error-toast__sub">{sub}</p>
      </div>
      <button
        type="button"
        aria-label="关闭提示"
