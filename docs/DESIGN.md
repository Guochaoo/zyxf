...
| Popover (Level 3) | 纯投影浮层，**无任何描边/光晕圈**（连 shadow-as-border ring 都不用）：rgba(0,0,0,0.06) 0 4px 10px + rgba(0,0,0,0.12) 0 12px 32px 双层柔和投影 | 卡片内悬浮层（如智能对话的 AI 设置浮层）；无界——浮层边界完全由投影海拔表达 |
